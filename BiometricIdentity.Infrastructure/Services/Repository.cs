using BiometricIdentity.Infrastructure.Data;
using System;
...
namespace BiometricIdentity.Infrastructure.Services
{
    /// <summary>
    /// <inheritdoc/>
    /// </summary>
    ...
    public class Repository<TKey, TModel> : IRepository<TKey, TModel> where TModel : class
    {
        ...
        public DbResult SaveChanges()
        {
            try
            {
                ...
                return new DbResult { Succeeded = true, Message = "" };
            }
            catch(Exception e)
            {
                return new DbResult { Succeeded = false, Message = e.Message };
            }
        }
